...
<%
   int id = Integer.parseInt(request.getParameter("rid"));
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/webtech",
     ...
     String queryString = "UPDATE request SET status = 'approved' WHERE requestID = '" + id + " '";
     ...
     String queryString2 = "UPDATE vehicle SET vehicleStatus = 'reserved' WHERE vehicleID = '" + vid + " '";
